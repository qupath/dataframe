            ...
            public Series<Comparable<Object>> get(int series) {
                ...
                if (this.series[series] == null) {
                    switch (groupBy.dataFrame.get(series).getType()) {
                        case LONG:
                            this.series[series] = new SeriesImpl.SeriesView<>(groupBy.dataFrame.getLongSeries(series), groupBy.groupBy.getGroup(index), groupBy.groupBy.getGroup(index).size());
                            break;
                        case BOOLEAN:
                            this.series[series] = new SeriesImpl.SeriesView<>(groupBy.dataFrame.getBooleanSeries(series), groupBy.groupBy.getGroup(index), groupBy.groupBy.getGroup(index).size());
                            break;
                        case DOUBLE:
                            this.series[series] = new SeriesImpl.SeriesView<>(groupBy.dataFrame.getDoubleSeries(series), groupBy.groupBy.getGroup(index), groupBy.groupBy.getGroup(index).size());
                            break;
                        case STRING:
                            this.series[series] = new SeriesImpl.SeriesView<>(groupBy.dataFrame.getStringSeries(series), groupBy.groupBy.getGroup(index), groupBy.groupBy.getGroup(index).size());
                            break;
                        default:
                            throw new UnsupportedOperationException();
                    }
