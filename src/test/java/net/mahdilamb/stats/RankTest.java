...
public class RankTest {
    ...
    public void petalWidthTest() {
        ...
        assertArrayEquals(
                ...
                StatUtils.rankData(x::getDouble, x.size(), "dense"),
                0
        );
        assertArrayEquals(
                ...
                StatUtils.rankData(x::getDouble, x.size(), "ordinal"),
                0
        );
        assertArrayEquals(
                ...
                StatUtils.rankData(x::getDouble, x.size(), "min"),
                0
        );
        assertArrayEquals(
                ...
                StatUtils.rankData(x::getDouble, x.size(), "max"),
                0
        );
        assertArrayEquals(
                ...
                StatUtils.rankData(x::getDouble, x.size(), "average"),
                0
        );
    }
